...
:::message
Astro と SSR
MPA[^MPA] のフレームワークである Astro でも、 SSR は [On-demand Rendering](https://docs.astro.build/en/guides/on-demand-rendering/) という機能として存在しており、ページリクエスト時にオンデマンドにサーバーサイドで HTML を生成する仕組みを指します。 
:::
